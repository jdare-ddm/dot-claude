...
- `/add-dir ~/sandbox/m-ksl-cars` — Cars vertical frontend (KSL Cars specific components and pages)
- `/add-dir ~/sandbox/m-ksl-cars-api` — Cars vertical API (backend services for KSL Cars)
